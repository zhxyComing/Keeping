...
public class CalculationDetailMonthAdapter extends BaseAdapter implements IDetailData<MonthItemBean> {

    private List<MonthItemBean> mDetails;
    private Context mContext;

    public CalculationDetailMonthAdapter(Context context, List<MonthItemBean> details) {
        this.mContext = context;
        this.mDetails = details;
    }

    @Override
    public List<MonthItemBean> getDetails() {
        return mDetails;
    }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        final MonthItemBean itemDetail = mDetails.get(position);
        vh.timeDescView.setText(itemDetail.getMonthDesc());
